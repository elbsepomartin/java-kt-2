...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BasicBurger whopperBurger = new BasicBurger("whopperBurger");
        ...
        while (true) {
            ...
            System.out.println("Insert your sides (maximum of 4). Leave empty, if you are done with sides: ");
            ...
            System.out.println("Available burgers: " + burgers);

            if (!sides.isEmpty() && sides.size() <= 4) {

                Sides sideCombo = new Sides(sides);
                System.out.println("Insert your burger: ");
                ...
                if (burgerOrder.equals("whopperBurger")) {
                    ...
                    System.out.println("Continue? (Return to continue/type no or n to end order): ");
                    cont = input.nextLine();
                    ...
                    System.out.println("This burger does not exist.");
                    System.out.println("Continue? (Return to continue/type no or n to end order): ");
                    cont = input.nextLine();
                }
                ...
                if (burgerOrder.equals("whopperBurger")) {
                    ...
                    System.out.println("The burger does not exist.");
                    System.out.println("Continue? (Return to continue/type no or n to end order): ");
                    cont = input.nextLine();
